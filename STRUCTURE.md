...
│
├── .github/
│   ├── PULL_REQUEST_TEMPLATE.md     ← 12 领域下拉
...
| 路径 | 用途 | 谁应该写 |
|---|---|---|
| `<12 领域之一>/` | **case 主目录**（领域）| 全球开发者 / 玩家（PR） |
...
| 2026-07-08 **v3** ✨ | **12 领域 + 锦绣 + skill-creator + 全球开源** | **本次跃迁** |
