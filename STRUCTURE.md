...
| # | 领域（一级目录）| 范围 |
|---|---|---|
| 1 | **ai-agent** | LLM / Agent / 提示工程 / 机器学习 |
| 2 | **coding** | 通用编程 / 架构 / 模式 / 最佳实践 / 前后端 / 移动 |
| 3 | **data-science** | 数据分析 / 可视化 / 统计 / BI / 量化研究 |
| 4 | **product-design** | 产品方法论 / UX / UI / 用户研究 / 需求管理 |
| 5 | **business-model** | 营销 / 增长 / 用户运营 / 商业模式 / 私域 |
| 6 | **trading-review** | A 股 / 港美股 / 加密货币 / 量化 / 财务规划 |
| 7 | **content-ops** | 视频 / 写作 / 直播 / 摄影 / 短视频 |
| 8 | **learning** | 学科教育 / 语言学习 / 知识管理 / 学习方法 |
| 9 | **gaming** | 游戏攻略 / 角色养成 / 副本流程 / MOD 制作 / 二创 |
| 10 | **lifestyle** | 健康 / 时间管理 / 关系 / 旅行 / 美食 / 家居 |
| 11 | **pkm-decision** | 决策框架 / 思维模型 / 心理学 / 认知科学 |

### 命名逻辑（为什么这么命名）

| 领域 | 命名理由 |
|---|---|
| ai-agent（不是 AI培训）| 能力是双向的（既给 AI 学，又用人学 AI）|
| coding（不是 开发）| 含"编程"= 强调实践 |
| trading-review（不是 金融分析）| "投资"强调价值导向，"分析"偏方法论 |
| content-ops（不是 创作）| "内容"强调输出形式（视频 / 文字 / 图片）|
| pkm-decision（不是 认知）| "方法"更实用 = 学了能用 |
| gaming（不是 游戏）| "玩家"强调身份认同 = 这就是为玩家做的方法论 |
